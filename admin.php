...
<table class="table table-bordered w-75 m-auto">
            ...
            <tbody>
                ...
                <tr>
                    <td class="text-center"><?=$users[$i]['idUser']?></td>
                    <td class="text-center"><?=$users[$i]['pseudo']?></td>
                    <td class="text-center"><?=$users[$i]['password']?></td>
                    <td class="text-center"><?=$users[$i]['profile_image']?></td>
                    <td class="text-center">
                        <a class="text-decoration-none " href="api/users/delete_user.php?id=<?=$users[$i]['idUser']?>">
